...
func TestCryptoPerpDataLatestBars(t *testing.T) {
	t.Parallel()
	out := alpaca(t, "crypto-perp", "data", "latest-bars", "--symbols", "BTC.P", "--loc", "global")
...
func TestCryptoPerpDataLatestTrades(t *testing.T) {
	t.Parallel()
	out := alpaca(t, "crypto-perp", "data", "latest-trades", "--symbols", "BTC.P", "--loc", "global")
	data := parseJSONMap(t, out)
...
func TestCryptoPerpDataLatestQuotes(t *testing.T) {
	t.Parallel()
	out := alpaca(t, "crypto-perp", "data", "latest-quotes", "--symbols", "BTC.P", "--loc", "global")
	data := parseJSONMap(t, out)
...
func TestCryptoPerpDataLatestOrderbooks(t *testing.T) {
	t.Parallel()
	out := alpaca(t, "crypto-perp", "data", "latest-orderbooks", "--symbols", "BTC.P", "--loc", "global")
	data := parseJSONMap(t, out)
...
func TestCryptoPerpDataLatestFuturesPricing(t *testing.T) {
	t.Parallel()
	out := alpaca(t, "crypto-perp", "data", "latest-futures-pricing", "--symbols", "BTC.P", "--loc", "global")
	data := parseJSONMap(t, out)
